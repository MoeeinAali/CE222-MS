...
% Global listing appearance (set language=Go/Python per block, not here)
\lstset{
...
\سربرگ{تمرین چهارم}{}{پاسخ‌دهنده: معین آعلی - 401105561}{استاد: دکتر علی ابریشمی - سیدحسین میرحسینی}
