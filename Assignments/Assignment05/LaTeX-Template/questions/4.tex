...
\begin{itemize}
    ...
    \item \textbf{\lr{ARG MIRROR\_TRUSTED\_HOST=""}:}
    وقتی میرور فقط روی \lr{HTTP} در دسترس است (مثلاً یک مخزن داخلی مثل \lr{Nexus} در سؤال ۸)، این مقدار به \lr{pip install --trusted-host} داده می‌شود تا نصب به‌خاطر نبود \lr{HTTPS} رد نشود.
